                                    ...
                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                ...
                                                if(isset($search_val))
                                                {
                                                    $sql15 = "SELECT id, first_name, last_name, username, age, email, role FROM users WHERE id='$search_val' OR first_name='$search_val' OR last_name='$search_val' OR username='$search_val' OR age='$search_val' OR email='$search_val' OR role='$search_val'";
