                                            ...
                                            echo "
                                                ...
                                                <div class='INPUT_CONTAINER col flex-wrap p-0'>
                                                    <div class='col border'style='height: 3rem;'>
                                                        <input disabled minlength='3' maxlength='16' type='text' name='first_name' value='".$row['first_name']."' placeholder='First name' style='border-style: none; outline-style: none; background: transparent; width: 100%; height: 100%; padding-left: 1rem;'>
                                                    </div>
                
                                                    <div class='col-auto p-2'></div>
                
                                                    <div class='col border' style='height: 3rem;'>
                                                        <input disabled minlength='3' maxlength='16' type='text' name='last_name' value='".$row['last_name']."' placeholder='Last name' style='border-style: none; outline-style: none; background: transparent; width: 100%; height: 100%; padding-left: 1rem;'>
                                                    </div>
                                                </div>
                                                ...
                                                <div class='INPUT_CONTAINER col flex-wrap p-0'>
                                                    <div class='col border' style='height: 3rem;'>
                                                        <input disabled min='4' maxlength='8' type='text' name='username' value='".$row['username']."' placeholder='Username' style='border-style: none; outline-style: none; background: transparent; width: 100%; height: 100%; padding-left: 1rem;'>
                                                    </div>
                
                                                    <div class='col-auto p-2'></div>
                
                                                    <div class='col border' style='height: 3rem;'>
                                                        <input disabled maxlength='2' type='text' name='age' placeholder='Age' value='".$row['age']."' style='border-style: none; outline-style: none; background: transparent; width: 100%; height: 100%; padding-left: 1rem;'>
                                                    </div>
                                                </div>
                                                ...
                                                <div class='INPUT_CONTAINER col flex-wrap p-0'>
                                                    <div class='col border' style='height: 3rem;'>
                                                        <input disabled maxlength='2' type='text' name='email' placeholder='Email' value='".$row['email']."' style='border-style: none; outline-style: none; background: transparent; width: 100%; height: 100%; padding-left: 1rem;'>
                                                    </div>
                
                                                    <div class='col-auto p-2'></div>
                
                                                    <div class='col border' style='height: 3rem;'>
                                                        <input disabled maxlength='2' type='text' name='role' placeholder='Role' value='".$row['role']."' style='border-style: none; outline-style: none; background: transparent; width: 100%; height: 100%; padding-left: 1rem;'>
                                                    </div>
                                                </div>
                                                ...
                                                <div class='col p-0 border-primary' style='height: 3rem;'>
                                                    <button type='submit' name='edit' value='".$row['id']."' class='w-100 h-100 bg-primary' style='border-style: none;'>
                                                        <span class='text-white' style='font-family: Poppins-regular; font-size: 1rem;'> EDIT USER </span>
                                                    </button>
                                                </div>
                                                ...
                                                <div class='col p-0 border-primary' style='height: 3rem;'>
                                                    <button type='submit' name='delete' value='".$row['id']."' class='w-100 h-100 bg-warning' style='border-style: none;'>
                                                        <span class='text-white' style='font-family: Poppins-regular; font-size: 1rem;'> DELETE USER </span>
                                                    </button>
                                                </div>
