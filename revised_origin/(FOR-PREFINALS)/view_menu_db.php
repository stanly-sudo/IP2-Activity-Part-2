<?php
    ...
    else if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['edit']))
    {
        ...
        $conn->close();
        header("Location: edit_menu_db.php?&id=".$id."&menuID=".$menuID);
    }
    else if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['delete']))
    {
        ...
        if(isset($menuID))
        {
            $sql = "DELETE FROM shop_menu WHERE menuID='$menuID'";

            if($conn->query($sql) === TRUE) 
            {
              header("Location: menustable.php?message=Item sucessfully deleted!&id=".$id);
            } 
            else 
            {
                                        ...
                                        <div class="CONTENT justify-content-center align-items-center" style="gap: 1rem;">
                                            ...
                                            <div class="bg-white p-1 w-100">
                                                ...
                                                <?php
                                                    ...
                                                    if(isset($menuID))
                                                    {
                                                        $sql7 = "SELECT menuID, menu_image, menu_price, menu_name, menu_description, menu_state FROM shop_menu WHERE menuID='".$menuID."'";
                                                                ...
                                                                echo"
                                                                    <div class='d-flex flex-row'>
                                                                            ...
                                                                            <div class='col-auto p-0'>
                                                                                <button type='submit' name='edit' value='".$row['menuID']."' class='b_2 d-flex justify-content-center align-items-center w-1' title='Edit profile'>
                                                                    ...
                                                                    <div class='d-flex flex-wrap align-items-center w-100'>
                                                                        ...
                                                                        <div class='col d-flex justify-content-center align-items-center'> <i class='fas fa-calendar fa-sm fa-fw mr-2 text-gray-400'></i> <span> ".$row['menu_price']." </span> </div>
                                                                        <div class='col d-flex justify-content-center align-items-center'> <i class='fas fa-user fa-sm fa-fw mr-2 text-gray-400'></i> <span> ".$row['menu_description']." </span> </div>
                                                                        <div class='col d-flex justify-content-center align-items-center'> <i class='fas fa-map fa-sm fa-fw mr-2 text-gray-400'></i> <span> ".$row['menu_state']." </span> </div>
                                                                    ...
                                                                    <div class='w-100' style='height:3rem;'>
                                                                        <button type='submit' name='delete' value='".$row['menuID']."' class='w-100 h-100' style='background-color: #F28B82; color: #D33939; border: none; cursor: pointer;'>
                                                                            Delete item
                                                                        </button>
                                                                    </div>
