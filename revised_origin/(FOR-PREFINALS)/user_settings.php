                            ...
                            <div class="CONTENT justify-content-center align-items-center" style="gap: 1rem;">
                                ...
                                <div class="border bg-white p-1" style="width: 50rem;">
                                    ...
                                    <div class="d-flex flex-column justify-content-start align-items-center p-3" style="gap: 1rem;">
                                        ...
                                        <div class="col-auto d-flex flex-row w-100 p-0" style="height: 2.5rem;">
                                            <div class="col-auto d-flex justify-content-center align-items-center" style="padding-left: 1.5rem; width: 2rem;"> <i class="fas fa-trash fa-sm fa-fw mr-2 text-red-400"></i> </div>
                                            <div class="col p-0">
                                                <input type="submit" name="delete_account" value="Delete Account." class="h-100" style="border-style:none; width:8rem; background:transparent;">
                                            </div>
                                        </div>
                                        ...
                                        <!-- button: save changes -->
                                        <div class="d-flex flex-row justify-content-center align-items-center p-0 w-100" style="border: 1px solid #D33939; background-color: #D33939; height: 2.5rem;">
                                            ...
                                            <button type="submit" name="sign_out" class="w-100 h-100" style="border-style:none; background:transparent;">
                                                <span style="color:#ffff;"> SIGN OUT </span>
                                            </button>
                                        </div>
