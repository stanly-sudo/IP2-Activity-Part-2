<?php
    ...
    else if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['edit_profile']))
    {
        $conn->close();
        header("Location: edit_admin_profile.php?&id=".$id);
    }
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="border bg-white p-1" style="width: 50rem;">
                                    ...
                                    <div class="d-flex flex-row">
                                            ...
                                            <div class="col-auto p-0">
                                                <button type="submit" name="edit_profile" class="b_2 d-flex justify-content-center align-items-center w-1" title="Edit profile">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center">
                                        ...
                                        <div class="col d-flex justify-content-center align-items-center"> <i class="fas fa-calendar fa-sm fa-fw mr-2 text-gray-400"></i> <span> <?php echo $age; ?> </span> </div>
                                        <div class="col d-flex justify-content-center align-items-center"> <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i> <span> <?php echo $username ?> </span> </div>
                                        <div class="col d-flex justify-content-center align-items-center"> <i class="fas fa-map fa-sm fa-fw mr-2 text-gray-400"></i> <span> <?php echo $address ?> </span> </div>
