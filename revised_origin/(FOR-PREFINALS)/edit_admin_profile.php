                                        ...
                                        if(is_numeric($this->age))
                                        {
                                            if($this->age >= 18)
                                            {
                                                if(!empty($this->address))
                                                {
                                                    ...
                                                    {
                                                        $this->conn->close();
                                                        header("Location: admin_profile.php?message=Update Successful&id=".$id);
                                                    } 
                                                    else 
                                                    {
                                    ...
                                    if(!empty($this->age))
                                    {
                                        if(is_numeric($this->age))
                                        {
                                            if($this->age >= 18)
                                            {
                                                if(!empty($this->address))
                                                {
                                                    header("Location: admin_profile.php?message=Username already exists!&id=".$id);
                                                }
                                                else
                                                {
                                                    echo "<script> alert('Please fill in your address.') </script>";
                            ...
                            <div class="CONTENT justify-content-center align-items-center" style="gap: 1rem;">
                                ...
                                <div class="border bg-white p-1" style="width: 50rem;">
                                    ...
                                    <div class="d-flex flex-column justify-content-start align-items-center p-3" style="gap: 1rem;">
                                        ...
                                        <!-- <div class="col d-flex justify-content-start align-items-center"> <i class="fas fa-pencil-alt fa-sm fa-fw mr-2 text-gray-400"></i> <span> <?php echo $age; ?> </span> </div>
                                        <div class="col d-flex justify-content-start align-items-center"> <i class="fas fa-pencil-alt fa-sm fa-fw mr-2 text-gray-400"></i> <span> <?php echo $age; ?> </span> </div>
                                        <div class="col d-flex justify-content-start align-items-center"> <i class="fas fa-pencil-alt fa-sm fa-fw mr-2 text-gray-400"></i> <span> <?php echo $username ?> </span> </div>
                                        <div class="col d-flex justify-content-start align-items-center"> <i class="fas fa-pencil-alt fa-sm fa-fw mr-2 text-gray-400"></i> <span> <?php echo $address ?> </span> </div> -->
