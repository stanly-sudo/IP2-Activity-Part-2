<?php
    ...
    else if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['view']))
    {
        ...
        $conn->close();
        header("Location: view_menu_db.php?&id=".$id."&menuID=".$userID);
    }
    else if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['edit']))
    {
        ...
        $conn->close();
        header("Location: edit_menu_db.php?&id=".$id."&menuID=".$userID);
    }
    else if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['delete']))
    {
        ...
        if(isset($menuID))
        {
            ...
            {
              header("Location: menustable.php?message=Menu sucessfully deleted!&id=".$id);
            } 
            else 
            {
                        ...
                        <div class="card-header py-3 d-flex flex-row">
                            ...
                            <div class="col d-flex justify-content-end align-items-center p-0">
                                ...
                                <div class="COUNT col justify-content-end align-items-center">
                                    <span class="span_2" style="font-size: 1rem;"> Showing 1 out of <?php echo $pages2 ?> </span>
                                </div>
                                <div class="col-auto h-100 d-flex justify-content-center align-items-center" style="gap: 0.3rem;">
                                    ...
                                    <?php
                                            ...
                                            {
                                                echo"
                                                    <a href='?page-nr=$pages2&id=$id' class='border d-flex justify-content-center align-items-center' style='background-color: #f3f3f3; border-radius: 6px; width: 1.75rem; font-size: 1.5rem; text-align: center;' title='Last'>
                                                        <span> &raquo; </span>
                                                    </a>
                                                ";
                                            }
                                                ...
                                                if($result6->num_rows > 0)
                                                {
                                                    while($row = $result6->fetch_assoc())
                                                    {
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td>".$row['menu_state']."</td>
                                                                <td>                                  
                                                                        <button type='submit' name='view' value='".$row['menuID']."' style='background-color: #FBCFC4; color: #F57B5F; border: none; cursor: pointer;'>
                                                                            view
                                                                        </button>

                                                                        <button type='submit' name='edit' value='".$row['menuID']."' style='background-color: #C5D1A6; color: #91A168; border: none; cursor: pointer;'>
                                                                            edit
                                                                        </button>

                                                                        <button type='submit' name='delete' value='".$row['menuID']."' style='background-color: #F28B82; color: #D33939; border: none; cursor: pointer;'>
                                                                            delete
                                                                        </button>
                                                                </td>
                                                            </tr> 
