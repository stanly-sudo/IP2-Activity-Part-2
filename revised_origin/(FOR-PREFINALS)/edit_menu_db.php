<?php
    ...
    else if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['cancel_editing']))
    {
        ...
        $conn->close();
        header("Location: view_menu_db.php?&id=".$id."&menuID=".$menuID);
    }
    else if($_SERVER['REQUEST_METHOD']==='POST' && isset($_POST['save_changes']))
    {
        ...
        if(isset($menuID))
        {
            ...
            $sql8 = "SELECT menuID, menu_price, menu_name, menu_description, menu_state FROM shop_menu WHERE menuID='$menuID'";
            ...
            if($result8->num_rows > 0)
            {
                ...
                {
                    // echo "hello world".$row['menu_name'];

                    $price=$_POST['menu_price'];

                    $current_name=$_POST['menu_name'];
                    $name=$_POST['menu_name'];

                    $description=$_POST['menu_description'];
                    $state=$_POST['menu_state'];
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    if($menu_type==="Edible")
                                    {
                                        ...
                                        $sql = "SELECT menuID FROM shop_menu WHERE menu_name='$name'";
                                        ...
                                        if($name === $current_name)
                                        {
                                            ...
                                            $sql="update shop_menu set `menu_image`='assets/ramen.png', `menu_name`='$name',`menu_description`='$description',`menu_price`='$price', `menu_type`='$menu_type',`menu_state`='$state' WHERE menuID='$menuID'";

                                            if ($conn->query($sql) === TRUE) 
                                            {
                                                header("Location: edit_menu_db.php?message=Item has been updated&id=".$id."&menuID=".$menuID);
                                            } 
                                            else 
                                            {
                                        ...
                                        {
                                            // echo "<script> alert('updated.') </script>";
                                            $sql="update shop_menu set `menu_image`='assets/ramen.png', `menu_name`='$name',`menu_description`='$description',`menu_price`='$price',`menu_state`='$state' WHERE menuID='$menuID'";
                                    ...
                                    else if($menu_type==="Drink")
                                    {
                                        ...
                                        {
                                            // echo "<script> alert('updated.') </script>";
                                            $sql="update shop_menu set `menu_image`='assets/drink.png', `menu_name`='$name',`menu_description`='$description',`menu_price`='$price', `menu_type`='$menu_type',`menu_state`='$state' WHERE menuID='$menuID'";
                                        ...
                                        {
                                            // echo "<script> alert('updated.') </script>";
                                            $sql="update shop_menu set `menu_image`='assets/drink.png', `menu_name`='$name',`menu_description`='$description',`menu_price`='$price',`menu_state`='$state' WHERE menuID='$menuID'";
                                ...
                                <div class="CONTENT justify-content-center align-items-center" style="gap: 1rem;">
                                    ...
                                    <div class="col d-flex flex-column">
                                        ...
                                        <?php
                                                ...
                                                if(isset($menuID))
                                                {
                                                    $sql5 = "SELECT menuID, menu_image, menu_price, menu_name, menu_description, menu_type, menu_state FROM shop_menu WHERE menuID='".$menuID."'";
                                                    ...
                                                    if($result5->num_rows > 0)
                                                    {
                                                        while($row = $result5->fetch_assoc())
                                                        {
                                                            ...
                                                            if($row['menu_type']==="Edible")
                                                            {
                                                                echo "
                                                                    ...
                                                                    <div class='col-auto d-flex justify-content-center align-items-center' style='height: 10rem;'>
                                                                        <div class='col-auto d-flex justify-content-center align-items-center' style='border: 1px solid #F2E7C9; background-color: #F2E7C9; border-radius: 50%; width: 6rem; height: 6rem;'>
                                                                            <img src='".$row['menu_image']."' alt='...' width='40rem' height='40rem'>
                                                                        </div>
                                                                    </div>
                                                                    ...
                                                                    <div class='d-flex flex-column justify-content-start align-items-center p-3' style='gap: 1rem;'>
                                                                        ...
                                                                        <div class='col-auto border d-flex flex-row w-100 p-0' style='height: 2.5rem;'>
                                                                            ...
                                                                            <div class='col'>
                                                                                <input type='text' name='menu_price' value='".$row['menu_price']."' class='w-100 h-100' style='border-style:none;'>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class='col-auto border d-flex flex-row w-100 p-0' style='height: 2.5rem;'>
                                                                            <div class='col-auto d-flex justify-content-center align-items-center' style='padding-left: 1.5rem; width: 2rem;'> <i class='fas fa-pencil-alt fa-sm fa-fw mr-2 text-gray-400'></i> </div>
                                                                            <div class='col'>
                                                                                <input type='text' name='menu_name' value='".$row['menu_name']."' class='w-100 h-100' style='border-style:none;'>
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class='col-auto border d-flex flex-row w-100 p-0' style='height: 2.5rem;'>
                                                                            <div class='col-auto d-flex justify-content-center align-items-center' style='padding-left: 1.5rem; width: 2rem;'> <i class='fas fa-pencil-alt fa-sm fa-fw mr-2 text-gray-400'></i> </div>
                                                                            <div class='col'>
                                                                                <input type='text' name='menu_description' value='".$row['menu_description']."' class='w-100 h-100' style='border-style:none;'>
                                                                            </div>
                                                                        </div>

                                                                        <div class='col-auto border d-flex flex-row w-100 p-0' style='height: 2.5rem;'>
                                                                            <div class='col'>
                                                                                <select name='menu_type' class='w-100 h-100'>
                                                                        ...
                                                                        <div class='col-auto border d-flex flex-row w-100 p-0' style='height: 2.5rem;'>
                                                                            <div class='col'>
                                                                                <select name='menu_state' class='w-100 h-100'>
                                                                                    <option value='".$row['menu_state']."'> ".$row['menu_state']." </option>
                                                            ...
                                                            else if($row['menu_type']==="Drink" && $row['menu_state']==="Unavailable")
                                                            {
                                                                echo "
                                                                    <div class='d-flex flex-row'>
                                                                            <div class='col'></div>
