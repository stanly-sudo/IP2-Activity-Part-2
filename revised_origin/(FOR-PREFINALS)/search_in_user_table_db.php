                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3 d-flex flex-row">
                            ...
                            <div class="HEADLINE col justify-content-start align-items-center p-0" style="gap: 0.8rem;">
                               ...
                               <div class="SEARCHBAR col p-0 w-100 h-100 flex-row" style="border: 1px solid #c3c3c3;" title="Search">
                                    <form method="POST" class="d-flex flex-row w-100">
                                        <div class="col-auto border p-0 h-100" style="width: 2.5rem;">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" width="100%" cellspacing="0">
                                        ...
                                        <tbody>
                                            ...
                                            <?php
                                                $search_val = mysqli_real_escape_string($conn, $_GET['search_value']);
                                                if(isset($search_val))
                                                {
                                                    $sql15 = "SELECT id, profile_image, first_name, last_name, username, age, address, role FROM users WHERE id='$search_val' OR first_name='$search_val' OR last_name='$search_val' OR username='$search_val' OR age='$search_val' OR address='$search_val' OR role='$search_val'";
                                                ...
                                                if($result15->num_rows > 0)
                                                {
                                                    while($row = $result15->fetch_assoc())
                                                    {
                                                        ...
                                                        <tr>
                                                                ...
                                                                <td>".$row['role']."</td>
                                                                <td>                                  
                                                                        <button type='submit' name='view' value='".$row['id']."' style='border: 1px solid #0d6efd; background-color: #ffff; color: #0d6efd; border: none; cursor: pointer;'>
                                                                            view
                                                                        </button>

                                                                        <button type='submit' name='edit' value='".$row['id']."' style='border: 1px solid #0d6efd; background-color: #ffff; color: #0d6efd; border: none; cursor: pointer;'>
                                                                            edit
                                                                        </button>

                                                                        <button type='submit' name='delete' value='".$row['id']."' style='border: 1px solid #0d6efd; background-color: #ffff; color: #0d6efd; border: none; cursor: pointer;'>
                                                                            delete
                                                                        </button>
                                                                </td>
                                                            </tr> 
                                                ...
                                                {
                                                    echo "<tr> <td class='d-flex justify-content-start align-items-center' style='border:none; height:5rem;'> No results </td> </tr>";
                                                }         
                                            ?>
