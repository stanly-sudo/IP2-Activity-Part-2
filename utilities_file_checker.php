...
<head>
    ...
    <title>Cloudy - File checker</title>
                        ...
                        <div class="CARD col p-3 border bg-white">
                            <form method="POST" class="p-1" enctype="multipart/form-data">
                                ...
                                <br>
                                        ...
                                        <div class="mb-3">
                                            <input type="text" name="file_name" value="<?= htmlspecialchars($file_hash) ?>" placeholder="Generated hash" class="form-control" style="height: 3rem;" disabled>
                                        </div>
                                        <div class="mb-3">
                                        ...
                                        <div>
                                            <button type="submit" name="add_to_cloud" value="Verify" class="btn btn-primary w-100" style="height: 3rem; font-family: Poppins-regular; font-size: 1rem;">
                                                VERIFY FILE
                                            </button>
                                        </div>
