<?php
            ...
            if(isset($id))
            {
                ...
                if(mysqli_num_rows($result) > 0)
                {
                    while($row = $result->fetch_assoc())
                    {
                        ...
                        {
                            $sql3 = "INSERT INTO `cloud` (cloudID, id, email, file, file_name , file_ext, file_size, file_size_unit, file_hash) VALUES (NULL, '$userID', '$email', '".$this->file."', '".$this->file_name."', '$file_extension', '".$this->file_size."', '".$this->file_size_unit."', '".$this->file_hash."')";
    ...
    if($_SERVER['REQUEST_METHOD'] === "POST" && isset($_POST['add_to_cloud']))
    {   
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light topbar mb-4 static-top shadow" style="background-color: #ffff;">
                    ...
                    <div class="col d-flex justify-content-start align-items-center">
                        <span class="HEADING text-primary" style="font-family: Poppins-regular; font-size: 1.75rem;"> Adding file </span>
                    </div>
                            ...
                            <div class="card shadow">
                                ...
                                <div class="card-body">
                                    <form method="POST" enctype="multipart/form-data">
                                        ...
                                        <div>
                                            <button type="submit" name="add_to_cloud" class="btn btn-primary w-100" style="height: 3rem; font-family: Poppins-regular; font-size: 1rem;">
                                                ADD TO CLOUD
                                            </button>
                                        </div>
                                    </form>
