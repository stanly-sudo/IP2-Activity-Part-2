<?php
    ...
    class createuser
    {
        ...
        public function __construct($first_name = "", $last_name = "", $username = "", $age = "", $email = "", $role = "", $password = "", $cpassword = "", $conn="")
        {
                                                                    ...
                                                                    if($this->password === $this->cpassword)
                                                                    {
                                                                        ...
                                                                        else
                                                                        {
                                                                            ...
                                                                            if(isset($id))
                                                                            {
                                                                                ...
                                                                                $sql = "INSERT INTO `users`(id, first_name, last_name, username, age, email, role, password) VALUES (NULL,'".$this->first_name."','".$this->last_name."','".$this->username."','".$this->age."','$EMAIL', '".$this->role."','$hash')";
                                                                                $result = mysqli_query($conn, $sql);
                                                                                ...
                                                                                $conn->close();
                                                                                header("Location: userstable.php?message=User+has+been+added+successfully!&id=".$id);
                                                                            }
                                                                        }
                                                                    }
                                                                    else
    ...
    {
        $createuser = new createuser($_POST['first_name'], $_POST['last_name'], $_POST['username'], $_POST['age'], $_POST['email'], $_POST['role'], $_POST['created_password'], $_POST['confirmed_password'], $conn);
    }
                    ...
                    <div class="row">
                        ...
                        <div class="CARD col p-3 border bg-white">
                            <form method="POST" class="p-1">
                                ...
                                <div class="INPUT_CONTAINER col flex-wrap p-0">
                                    <div class="col border d-flex flex-row justify-content-center align-items-center" style="height: 3rem;">
                                        <!-- input: email -->
                                        <div class="col p-0">
                                            <input type="text" name="email" placeholder="sample" class="h-100" style="border-style: none; outline-style: none; background: transparent; width: 100%; height: 100%; padding-left: 1rem;">
                                        </div>
                                ...
                                <div class="INPUT_CONTAINER col flex-wrap p-0">
                                    <div class="col p-0" style="height: 3rem;">
                                        <!-- input: create password -->
                                        <div class="INPUT border col p-0 d-flex justify-content-center align-items-center flex-row w-100 h-100">
                                ...
                                <div class="col p-0 border-primary" style="height: 3rem;">
                                    <button type="submit" name="create_user" class="w-100 h-100 bg-primary" style="border-style: none;">
                                        <span class="text-white" style="font-family: Poppins-regular; font-size: 1rem;"> CREATE USER </span>
                                    </button>
                                </div>
